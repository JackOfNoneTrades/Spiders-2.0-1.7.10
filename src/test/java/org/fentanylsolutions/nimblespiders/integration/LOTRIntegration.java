...
public final class LOTRIntegration {
    ...
    private static void playerRiding(WorldServer world, int scale) {
        ...
        org.fentanylsolutions.nimblespiders.common.SurfaceFrame view = org.fentanylsolutions.nimblespiders.common.entity.mob.ClimberRider
            .getViewFrame(rider, 1);
    ...
    private static void playerGroundControls(WorldServer world, FakePlayer rider) {
        ...
        org.fentanylsolutions.nimblespiders.common.Vec3d serverEye = org.fentanylsolutions.nimblespiders.common.entity.mob.ClimberRider
            .getEyePosition(rider);
        rider.yOffset = 1.62F;
        spider.updateRiderPosition();
        check(
            serverEye.subtract(org.fentanylsolutions.nimblespiders.common.entity.mob.ClimberRider.getEyePosition(rider))
                .lengthVector() < 0.001,
        ...
        check(
            serverEye
                .subtract(
                    org.fentanylsolutions.nimblespiders.common.entity.mob.ClimberRider.getEyePosition(clientRider))
                .lengthVector() < 0.001,
        ...
        for (int t = 0; t < 600; t++) {
            ...
            if (t % 100 == 0) System.out.println(
                "REPORTED_PILLAR t=" + t
                    ...
                    + spider.posZ
                    + " path="
                    + org.fentanylsolutions.nimblespiders.common.SpiderDebug.path(
                        spider.getNavigator()
                            .getPath()));
